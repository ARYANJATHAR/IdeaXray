...
export function ReportView({ analysis, report }: { analysis: AnalysisSnapshot; report: Report }) {
  ...
  return <div className="report">
    ...
    <section id="solutions" className="report-section"><div className="report-section-heading"><span>02</span><h2>Related products and potential solutions.</h2></div>
